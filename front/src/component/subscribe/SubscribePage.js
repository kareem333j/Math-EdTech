        ...
        if (courseContent.course != null) {
            return (
                <>
                    ...
                    <Helmet>
                        <title> منصة مستر مصطفي حمدي - الإشتراك في {courseContent.course.title}</title>
                        <meta name="description" content={`إشترك الأن في كورس ${courseContent.course.title} في منصة مستر مصطفي حمدي`} />
                    </Helmet>
                        ...
                        <Container>
                            ...
                            <div className='row content-div'>
                                <div className="notes-div col-lg-8 col-sm-12 col-md-12 row">
                                    ...
                                    <div className='item col-lg-12 col-sm-12 col-md-12 d-flex gap-2'>
                                        <LooksTwoIcon />
                                        <span className="content">قم بتحويل مبلغ <span className="fw-bold text-danger">({courseContent.course.price}ج)</span> من خلال فودافون كاش علي الرقم التالي : <span className="fw-bold text-danger">( 01068385363 )</span></span>
                                    </div>
                                    <div className='item col-lg-12 col-sm-12 col-md-12 d-flex gap-2'>
                                        <Looks3Icon />
