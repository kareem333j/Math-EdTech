                                                ...
                                                <div className='title d-flex gap-2 align-items-center w-100 mb-2 flex-column'>
                                                    ...
                                                    </div>
                                                    {
                                                        (question.img != null) ? <div className='w-90 question-image' onClick={
                                                            () => {
                                                                setDataImage({ src: `${question.img}`, alt: question.choice });
                                                                setViewImageWindow(true);
                                                            }} style={{ 'paddingRight': '0px', 'width': '95%', 'overflow': 'hidden', 'margin': '0', 'cursor': 'pointer' }}><img className='w-100 img' src={`${question.img}`} alt='question-image' /></div> : ''
                                                    }
                                                </div>
                                                                                    ...
                                                                                    <div className='d-flex gap-2 flex-column w-100'>
                                                                                        {convertNumbersToArabic(choice.choice)}
                                                                                        {
                                                                                            (choice.img != null) ? <div className='w-100 choice-img' onClick={
                                                                                                ...
                                                                                                style={{ 'paddingRight': '0px', 'width': '95%', 'overflow': 'hidden', 'margin': '0', 'cursor': 'pointer' }}><img className='w-100 img' src={`${choice.img}`} alt='question-image' /></div> : ''
                                                                                        }
                                                                                    </div>
                                                                                } />
                                                                            )
