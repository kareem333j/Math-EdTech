...
function Quiz({ id, dataAuth, close_screen, full_screen }) {
   ...
   const ViewImageWindow = () => {
        if (viewImageWindow) {
            return (
                <div id='view-image-window' onClick={() => setViewImageWindow(false)} className='view-image-window d-flex justify-content-center align-items-center p-0 pt-5 m-0'>
                    <div className='close'>
                        <Tooltip title="غلق">
                            <IconButton
                                        ...
                                        <div key={question.id} className='question w-100 d-flex flex-column mb-5' id={`q_${question.id}`}>
                                            <div className='title d-flex gap-2 align-items-center w-100 mb-2 flex-column'>
                                                ...
                                                </div>
                                                {
                                                    ...
                                                    } className='w-90 question-image' style={{ 'paddingRight': '0px', 'width': '95%', 'overflow': 'hidden', 'margin': '0', 'cursor': 'pointer' }}><img className='w-100 img' src={`${question.img}`} alt='question-image' /></div> : ''
                                                }
                                            </div>
                                                ...
                                                >
                                                    {
                                                        question.choices.map((choice) => {
                                                            if (choice.choice !== "" || choice.img != null) {
                                                                return (
                                                                    <>
                                                                            ...
                                                                            <div className='d-flex gap-2 flex-column w-100'>
                                                                                {convertNumbersToArabic(choice.choice)}
                                                                                {
                                                                                    (choice.img != null) ? <div onClick={
                                                                                        ...
                                                                                        className='w-100 choice-img' style={{ 'paddingRight': '0px', 'width': '95%', 'overflow': 'hidden', 'margin': '0', 'cursor': 'pointer' }}><img className='w-100 img' src={`${choice.img}`} alt='question-image' /></div> : ''
                                                                                }
                                                                            </div>
                                                                        } />
